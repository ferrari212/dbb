...
function Holtrop_calculate() {
    ...
    holtrop.lwl = parseFloat(document.getElementById("lwl_s").value);
    document.getElementById("lwl_val").value = holtrop.lwl;
    holtrop.breadth = parseFloat(document.getElementById("bwl_s").value);
    document.getElementById("bwl_val").value = holtrop.breadth;
    holtrop.tf = parseFloat(document.getElementById("tf_s").value);
    document.getElementById("tf_val").value = holtrop.tf;
    holtrop.ta = parseFloat(document.getElementById("ta_s").value);
    document.getElementById("ta_val").value = holtrop.ta;
    holtrop.lcb = parseFloat(document.getElementById("lcb_s").value);
    document.getElementById("lcb_val").value = holtrop.lcb;
    holtrop.cb = parseFloat(document.getElementById("cb_s").value);
    document.getElementById("cb_val").value = holtrop.cb;
    holtrop.csm = parseFloat(document.getElementById("mc_s").value);
    document.getElementById("mc_val").value= holtrop.csm;
    holtrop.cwl = parseFloat(document.getElementById("cwl_s").value);
    document.getElementById("cwl_val").value= holtrop.cwl;
    holtrop.vs = parseFloat(document.getElementById("sp_s").value);
    document.getElementById("sp_val").value= holtrop.vs;
    holtrop.b = parseFloat(document.getElementById("bb_s").value);
    document.getElementById("bb_val").value = holtrop.b;
    holtrop.tr = parseFloat(document.getElementById("tran_s").value);
    document.getElementById("tran_val").value = holtrop.tr;
    holtrop.cstern = parseFloat(document.getElementById("ab_s").value);
    document.getElementById("ab_val").value= holtrop.cstern;
    ...
    for (var i = 0; i <= 40; i++) { 
        ...
        plot2[i] = holtrop.rf[i]/1000;
        plot3[i] = holtrop.rf[i]*(holtrop.k -1)/1000;
        plot4[i] = holtrop.rapp[i]/1000;
        plot5[i] = holtrop.rw[i]/1000;
        plot6[i] = holtrop.rb[i]/1000;
        plot7[i] = holtrop.rtr[i]/1000;
        
        if (i === holtrop.vs) {
            $('.results').html("")         
            $('.total').html((holtrop.rtotal[i]).toFixed(2))           
            $('.frictional').html((holtrop.rf[i]/1000).toFixed(2))           
            $('.form').html((holtrop.rf[i]*(holtrop.k -1)/1000).toFixed(2))           
            $('.appendage').html((holtrop.rapp[i]/1000).toFixed(2))           
            $('.wave').html((holtrop.rw[i]/1000).toFixed(2))            
            $('.bulbous').html((holtrop.rb[i]/1000).toFixed(2))            
            $('.transom').html((holtrop.rtr[i]/1000).toFixed(2))           
            $('.correlation').html((holtrop.ra[i]/1000).toFixed(2))      
        }
    ...
    Plotly.newPlot('resistanceComponents', data, layout);
